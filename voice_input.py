...
Merged from three separate files:
  ...
  • voice_equalizer_patch.py (v9.1) — Animated EQ widget
  • voice_input.py           (v8.0) — Voice input panel UI
...
────────────────────────────────────────────────────────────────
v9.1: Animated 12-bar equalizer with nervousness colour theming.
  • Nervousness tint: green (calm) → cyan (moderate) → violet (high)
  • Pulsing REC dot + MM:SS timer while recording
  • Backwards-compatible audio_waveform() wrapper for existing callers

SECTION 3 — Voice Input Panel (voice_input_panel)
──────────────────────────────────────────────────
v8.0: Three-tab input panel (Whisper AI / Browser STT / Type).
  • Triple-layer data bridge (Method A/B/C) so transcripts survive Streamlit reruns
  • Live Filler + WPM HUD (Yoodli-style real-time coaching overlay)
  • MediaRecorder dual-track: live transcript + raw audio bytes for nervousness model

IMPORT CHANGE
─────────────
app.py and other callers that previously did:
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 2 — EQUALIZER WIDGET  (merged from voice_equalizer_patch.py)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 3 — VOICE INPUT PANEL  (merged from voice_input.py)
# ═══════════════════════════════════════════════════════════════════════════════
